...
In this task we would create 3 policy files for three different 32 byte hex keys which scone generates and passes as arguments to our second program P2, written in Go. P2 takes tree keys k1, k2 and k3 and creates a combined key by XORing them.
